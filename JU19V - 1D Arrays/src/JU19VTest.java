...
public class JU19VTest
{
  ...
  public void test01ChangeThe1stAnd4thValue1()
  {
    ...
    JU19V.changeThe1stAnd4thValue(myArray);
  ...
  public void test02TotalNumberOfElements1()
  {
    ...
    int[] b = {8, 8};
    int[] c = {9, 2, 3, 3};
    assertEquals(9, JU19V.totalNumberOfElements(a, b, c));
  }
  ...
  public void test02TotalNumberOfElements2()
  {
    ...
    int[] b = {8, 8, 23};
    int[] c = {3, 9};
    assertEquals(11, JU19V.totalNumberOfElements(a, b, c));
  }
  ...
  public void test02TotalNumberOfElements3()
  {
    ...
    assertEquals(16, JU19V.totalNumberOfElements(a, b, c));
  }
  ...
  public void test03GetCapacity1()
  {
    ...
    assertEquals(5, JU19V.getCapacity(myArray));
  }
  ...
  {
    int[] myArray = null;
    assertEquals(0, JU19V.getCapacity(myArray));
  }
  ...
  public void test03GetCapacity3()
  {
    ...
    assertEquals(378, JU19V.getCapacity(myArray));
  }
  ...
  public void test03GetCapacity4()
  {
    ...
    assertEquals(9, JU19V.getCapacity(myArray));
  }
  ...
  public void test04RaiseTheLastElementToThePower1()
  {
    ...
    JU19V.raiseTheLastElementToThePower(arr, 2);
  ...
  {
    int[] arr = {1, 2, 3};
    JU19V.raiseTheLastElementToThePower(arr, 5);
  ...
  public void test07GetNumberOfNonZeroElements1()
  {
    ...
    assertEquals(5, JU19V.getNumberOfNonZeroElements(myArray));
  }
  ...
  public void test08GetNumberOfNonZeroElements2()
  {
    ...
    assertEquals(3, JU19V.getNumberOfNonZeroElements(myArray));
  }
  ...
  public void test12EqualArrays1()
  {
    ...
    int[] yourArray = {1, 3, 3};
    int[] diffArray = {0, 3, 3};
    assertTrue(JU19V.equalArrays(myArray, yourArray));
    assertFalse(JU19V.equalArrays(myArray, diffArray));
  }
  ...
  public void test12EqualArrays2()
  {
    ...
    assertFalse(JU19V.equalArrays(myArray, yourArray));
    assertTrue(JU19V.equalArrays(myArray, diffArray));
  ...
  public void test14CountFortyTwos1()
  {
    ...
    assertEquals(3, JU19V.countFortyTwos(myArray));
  ...
  public void test14CountFortyTwos2()
  {
    ...
    assertEquals(2, JU19V.countFortyTwos(myArray));
  }
  ...
  public void test14CountFortyTwos3()
  {
    ...
    assertEquals(0, JU19V.countFortyTwos(myArray));
  }
  ...
  public void test15GetTotal1()
  {
    ...
    assertEquals(20, JU19V.getTotal(myArray));
  }
  ...
  public void test15GetTotal2()
  {
    ...
    assertEquals(18, JU19V.getTotal(myArray));
  }
  ...
  {
    int[] myArray = {1, 2};
    assertEquals(1.5, JU19V.getAverage(myArray), 0.01);
  }
  ...
  public void test16GetAverage2()
  {
    ...
    assertEquals(55.83, JU19V.getAverage(myArray), 0.01);
  }
  ...
  public void test16GetAverage3()
  {
    ...
    assertEquals(58.75, JU19V.getAverage(myArray), 0.01);
  }
  ...
  public void test17CalculateGrade1()
  {
    ...
    assertEquals("A", JU19V.calculateGrade(myArray));
  }
  ...
  {
    int[] myArray = {100, 90, 85, 20, 20, 20};
    assertEquals("F", JU19V.calculateGrade(myArray));
  }
  ...
  public void test17CalculateGrade3()
  {
    ...
    assertEquals("D", JU19V.calculateGrade(myArray));
  }
  ...
  public void test17CalculateGrade4()
  {
    ...
    assertEquals("B", JU19V.calculateGrade(myArray));
  }
  ...
  public void test18GetTheBiggest1()
  {
    ...
    assertEquals(343, JU19V.getTheBiggest(myArray));
  }
  ...
  public void test18GetTheBiggest2()
  {
    ...
    assertEquals(5000, JU19V.getTheBiggest(myArray));
  }
  ...
  public void test18GetTheBiggest3()
  {
    ...
    assertEquals(123, JU19V.getTheBiggest(myArray));
  }
  ...
  public void test19BookAtEndOfShelf1()
  {
    ...
    assertEquals("X", JU19V.bookAtEndOfShelf(myArray));
  }
  ...
  public void test19BookAtEndOfShelf2()
  {
    ...
    assertEquals("Z", JU19V.bookAtEndOfShelf(myArray));
  }
  ...
  public void test19BookAtEndOfShelf3()
  {
    ...
    assertEquals("Thor", JU19V.bookAtEndOfShelf(myArray));
  }
  ...
  public void test20ShiftAllForwardOne1()
  {
    ...
    JU19V.shiftAllForwardOne(myArray);
    assertEquals(
      "[-3, 1, 4, 9, 5]",
  ...
  @Test
  public void test21GetTotalLetters1()
  {
    String[] planets = {"Mercury", "Venus", "Earth"};
    assertEquals(17, JU19V.getTotalLetters(planets));
  }

  @Test
  public void test21GetTotalLetters2()
  {
    String[] starWars = {"Luke", "Yoda", "Obiwan", "Chewie", "Han"};
    assertEquals(23, JU19V.getTotalLetters(starWars));
  }
