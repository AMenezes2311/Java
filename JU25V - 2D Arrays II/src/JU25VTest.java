...
public class JU25VTest
{
  ...
  public void test01Build2DArrayWithRows1()
  {
    ...
    int[] arr1 = {1, 2, 2, 1};
    int[] arr2 = {3, 2, 7, 2};
    int[][] actual = JU25V.build2DArrayWithRows(arr0, arr1, arr2);
  ...
  public void test02ReturnLastRowOf2DArray1()
  {
    ...
    int[] actual = JU25V.returnLastRowOf2DArray(arr);
  ...
  public void test03AddTwoMatrices1()
  {
    ...
    int [][] y = {{7, 2}, {1, 2}};
    assertEquals("[8, 4]\n" + 
      "[5, 7]\n", beautify(JU25V.addTwoMatrices(x, y)));
  }
  ...
  public void test03AddTwoMatrices3()
  {
    int [][] x = {{1, 2, 2}, {4, 5, 9}};
    int [][] y = {{3, 1, 1}};
    assertEquals("null", beautify(JU25V.addTwoMatrices(x, y)));
  }
  ...
  public void test04SumOfAllElementsIn2DArray1()
  {
    ...
    assertEquals("19", JU25V.sumOfAllElementsIn2DArray(grid) + "");
  }
  ...
  public void test04SumOfAllElementsIn2DArray2()
  {
    ...
    assertEquals("30", JU25V.sumOfAllElementsIn2DArray(grid) + "");
  }
  ...
  public void test05GradeExam01()
  {
    ...
    String response = JU25V.gradeExam(answers, key);
