...
public class JU21VTest
{
  ...
  {
    int [] originalArr = {8, 5};
    int [] actual = JU21V.fill1DArray(originalArr);
  ...
  public void test02FillArrayList1()
  {
    ...
    arr.add(8);
    arr.add(5);
    ArrayList<Integer> actual = JU21V.fillArrayList(arr);
  ...
  public void test06RemoveTheFirstTwoValues1()
  {
    ...
    al.add(3);
    al.add(5);
    JU21V.removeTheFirstTwoValues(al);
  ...
  public void test08RemoveThatWord1()
  {
    ...
    fruit.add("apple");
    JU21V.removeThatWord(fruit, "apple");
  ...
  public void test08RemoveThatWord2()
  {
    ArrayList<String> fruit = new ArrayList<>();
    fruit.add("apple");
    JU21V.removeThatWord(fruit, "app");
    ...
    fruit2.add("apple");
    fruit2.add("app");
    JU21V.removeThatWord(fruit2, "app");
  ...
  public void test08RemoveThatWord4()
  {
    ...
    JU21V.removeThatWord(fruit, "grape");
    assertEquals("[apple]", fruit.toString());
  }
  ...
  public void test08RemoveThatWord5()
  {
    ...
    fruit.add("orange");
    fruit.add("grape");
    JU21V.removeThatWord(fruit, "orange");
  ...
  public void test10reverse1()
  {
    ...
    myDiet.add("orange");
    myDiet.add("beans");
    ArrayList<String> answer = JU21V.reverse(myDiet);
  ...
  public void test11GetSumButNotAfter42_1()
  {
    ArrayList<Integer> al = new ArrayList<>();
    al.add(3);
    assertEquals(3, JU21V.getSumButNotAfter42(al));
  }
  ...
  public void test11GetSumButNotAfter42_2()
  {
    ...
    al.add(3);
    al.add(1);
    assertEquals(4, JU21V.getSumButNotAfter42(al));
  }
  ...
  public void test11GetSumButNotAfter42_3()
  {
    ...
    al.add(4);
    al.add(1);
    assertEquals(18, JU21V.getSumButNotAfter42(al));
  }
  ...
  public void test11GetSumButNotAfter42_4()
  {
    ...
    al.add(42);
    al.add(1);
    assertEquals(47, JU21V.getSumButNotAfter42(al));
  }
  ...
  public void test11GetSumButNotAfter42_5()
  {
    ...
    al.add(3);
    al.add(1);
    assertEquals(42, JU21V.getSumButNotAfter42(al));
  }
  ...
  public void test12GetRange1()
  {
    ...
    al.add(3);
    al.add(1);
    assertEquals(41, JU21V.getRange(al));
  }
  ...
  public void test12GetRange2()
  {
    ...
    al.add(-5);
    al.add(2);
    assertEquals(8, JU21V.getRange(al));
  }
  ...
  public void test12GetRange3()
  {
    ...
    al.add(-21);
    al.add(25);
    assertEquals(109, JU21V.getRange(al));
  }
  ...
  public void test12GetRange4()
  {
    ...
    al.add(-4);
    al.add(-6);
    assertEquals(28, JU21V.getRange(al));
  }
  ...
  public void test13GetSizeOfBigWord1()
  {
    ...
    assertEquals(6, JU21V.getSizeOfBigWord(myList));
  }
  ...
  {
    ArrayList<String> myList = new ArrayList<>();
    assertEquals(0, JU21V.getSizeOfBigWord(myList));
  }
  ...
  public void test13GetSizeOfBigWord3()
  {
    ...
    assertEquals(5, JU21V.getSizeOfBigWord(myList));
  }
  ...
  public void test17ThreeOddEven1()
  {
    ...
    myList1.add(3);
    myList1.add(5);
    assertFalse(JU21V.threeOddEven(myList1));
    ArrayList<Integer> myList2 = new ArrayList<>();
    myList2.add(3);
    myList2.add(5);
    myList2.add(1);
    assertTrue(JU21V.threeOddEven(myList2));
  }
  ...
  public void test19WordPairs1()
  {
    ...
    ArrayList<String> actualList = JU21V.makeWordPairs(wordNums);
