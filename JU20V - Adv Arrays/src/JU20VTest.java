 ...
 * @version 4.0 - infinite loop protection/fixed FOREACH mixup.
 */
...
public class JU20VTest
{
  ...
  public void test01sayNamesRegularFOR1()
  {
    ...
    assertEquals("Start:<Grace><Ada>:Finish", JU20V.sayNamesRegularFOR(words));
  }
  ...
  public void test01sayNamesRegularFOR2()
  {
    ...
    assertEquals("Start:<Elvis><Paul><Mariah><Michael>:Finish",
      JU20V.sayNamesRegularFOR(words));
  }
  ...
  {
    String[] words = {"Grace", "Ada"};
    assertEquals("Start:<Grace><Ada>:Finish", JU20V.sayNamesFOREACH(words));
  }
  ...
  public void test03warmUpCount42RegularFOR1()
  {
    ...
    assertEquals(4, JU20V.warmUpCount42RegularFOR(numbers));
  }
  ...
  public void test03warmUpCount42RegularFOR2()
  {
    ...
    assertEquals(2, JU20V.warmUpCount42RegularFOR(numbers));
  }
  ...
  public void test03warmUpCount42RegularFOR3()
  {
    ...
    assertEquals(7, JU20V.warmUpCount42RegularFOR(numbers));
  }
  ...
  {
    int[] numbers = {9, 42, 42, 42, 42, 8};
    assertEquals(4, JU20V.warmUpCount42FOREACH(numbers));
  }
  ...
  {
    int[] numbers = {42, 0, 0, 42, 1};
    assertEquals(2, JU20V.warmUpCount42FOREACH(numbers));
  }
  ...
  {
    int[] numbers = {42, 0, 0, 42, 1, 7, 9, -4, 42, 7, 42, 42, 42, 9, 42};
    assertEquals(7, JU20V.warmUpCount42FOREACH(numbers));
  }
  ...
  {
    String[] myArray =
      JU20V.fillArrayWithNames("Rainbow", "Dash", "Power", "Ranger");
  ...
  {
    String[] myArray = JU20V.fillArrayWithNames("Joe", "Sue", "Steve", "Alex");
  ...
  {
    int[] wholeNumbers = JU20V.createArrayOfWholeNumbers(5);
  ...
  {
    int[] wholeNumbers = JU20V.createArrayOfWholeNumbers(20);
    assertEquals(
  ...
  {
    int[] wholeNumbers = JU20V.createArrayOfWholeNumbers(13);
  ...
  public void test06ReverseTheTruth1()
  {
    ...
    boolean[] actual = JU20V.reverseTheTruth(myArray);
  ...
  {
    int[] myArray = {1, 2, 3, 4};
    int[] actual = JU20V.doubleAllOfThem(myArray);
  ...
  public void test08AppendArrays1()
  {
    ...
    int[] actual = JU20V.appendArrays(myArray, yourArray);
  ...
  public void test09IsConsecutiveFour1()
  {
    ...
    assertTrue(JU20V.isConsecutiveFour(nums1));
    int[] nums2 = {42, 42, 7, 42};
    assertFalse(JU20V.isConsecutiveFour(nums2));
  }
  ...
  public void test10SwapEmIn1DArray1()
  {
    ...
    JU20V.swapEmIn1DArray(original, 0, 2);
  ...
  public void test10SwapEmIn1DArray2()
  {
    ...
    JU20V.swapEmIn1DArray(original, 5, 6);
    assertEquals("[1, 2, 3, 19, 30, 50]", Arrays.toString(original));
    int[] check = {5, 2};
    JU20V.swapEmIn1DArray(check, 0, 1);
  ...
  public void test10SwapEmIn1DArray3()
  {
    ...
    JU20V.swapEmIn1DArray(original, 3, 6);
