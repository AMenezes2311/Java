...
public class TestReview
{
  public static void main(String[] args)
  {
    ...
    System.out.println(Review.sentimentVal("film")); // 0.31
    System.out.println(Review.sentimentVal("fun")); // 1.59
    System.out.println(Review.sentimentVal("hyperbole")); // 0.0
    System.out.println(Review.sentimentVal("entertaining")); // 1.56
